    ...
    public void create(Duenio duenio) {
        ...
        try {
            ...
            for (Mascota listaMascotasMascotaToAttach : duenio.getListaMascotas()) {
                listaMascotasMascotaToAttach = em.getReference(listaMascotasMascotaToAttach.getClass(), listaMascotasMascotaToAttach.getNumeroCliente());
    ...
    public void edit(Duenio duenio) throws NonexistentEntityException, Exception {
        ...
        try {
            ...
            for (Mascota listaMascotasNewMascotaToAttach : listaMascotasNew) {
                listaMascotasNewMascotaToAttach = em.getReference(listaMascotasNewMascotaToAttach.getClass(), listaMascotasNewMascotaToAttach.getNumeroCliente());
